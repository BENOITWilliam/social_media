...
if ($db_found) {
/* Mise en place du menu admin emploi avec les fonction ajout modifier et suppression */
  ...
  while ($data = mysqli_fetch_assoc($result)) {
    ...
    echo '<td>
    <a href="regarder_emploi.php?ID_Emploi='.$data['ID_Emploi'].'"><button name="reg_'.$data['ID_Emploi'].'" class="btn btn-primary">Regarder</button><a></td>';
    echo '<td>
    <a href="modifier_emploi.php?ID_Emploi='.$data['ID_Emploi'].'"><button name="modif_'.$data['ID_Emploi'].'" class="btn btn-success">Modifier</button></a></td>';
