...
if ($db_found) {
  ...
  echo '<form enctype="multipart/form-data" method="POST"><div class="row g-0">
    <div class="col-sm-6 col-md-8"><br>
      <h3>Titre de l\'emploi :</h3><h4> <input type="text" class="form-control" maxlength="30" style="width: 700px;" name="Nom" value="" required/></h4><br><br>
  ...
  if(array_key_exists('soumettre',$_POST)){
    ...
    if($uploadfile != $uploaddir){
      ...
      $sql = 'INSERT INTO `emploi` (Nom,Desc_courte,Description,Image,Date) VALUES ("'.$Nom.'","'.$Desc_courte.'","'.$Description.'","'.$uploadfile.'","'.$date.'")';
    }
    else{$sql = 'INSERT INTO `emploi` (Nom,Desc_courte,Description,Date) VALUES ("'.$Nom.'","'.$Desc_courte.'","'.$Description.'","'.$date.'")';}
