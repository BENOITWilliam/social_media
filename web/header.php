<?php
/* Fichier stockant les infomations utilisateurs durant sa connexion au service */
$database = "likedin";
session_start();
...
if ($db_found) {
  ...
  if($data['MDP'] == $mdp){
    ...
    echo 'connecté<meta http-equiv="refresh" content="0; url=accueil.php">';

    exit();
  }
  else{echo "<div class='container'><div class='center_connexion'><center>L'utilisateur rentré ou le mot de passe n'est pas le bon.";
    echo '<br><br><a href=index.html><button class="btn btn-dark">Page Connexion</button></a></center></div></div>';}
  echo '</body>';
}
?>
